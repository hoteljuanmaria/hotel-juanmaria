      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Estamos aquí para ayudarte. Envíanos tu consulta y nos pondremos en
              ...
              <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  <div>
                    ...
                    <input
                      {...register('nombre')}
                      type='text'
                      className='w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-200 hover:border-gray-400 z-10 relative'
                ...
                <div>
                  ...
                  <select
                    ...
                    className='w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-200 hover:border-gray-400 z-10 relative'
                  >
                ...
                <div>
                  ...
                  <textarea
                    {...register('mensaje')}
                    rows={5}
                    className='w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-200 hover:border-gray-400 resize-none z-10 relative'
